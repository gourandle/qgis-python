...
<qgis version="3.0.2-Girona" simplifyMaxScale="1" maxScale="0" labelsEnabled="1" simplifyAlgorithm="0" minScale="1e+8" simplifyDrawingTol="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyDrawingHints="0">
  ...
  <labeling type="simple">
    <settings>
      ...
      <placement fitInPolygonOnly="0" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" dist="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" 
      maxCurvedCharAngleIn="25" yOffset="0" centroidWhole="0" distUnits="MM" offsetType="0" centroidInside="0" quadOffset="4" placement="6" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5" maxCurvedCharAngleOut="-25" repeatDistance="0" rotationAngle="0" xOffset="0" 
      offsetUnits="MapUnit" placementFlags="10" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    ...
    labelPlacementMethod="XHeight"diagramOrientation="Up" enabled="0" barWidth="5" penAlpha="255" width="15" penColor="#000000" height="15" 
    sizeType="MM" rotationOffset="270" backgroundAlpha="255" penWidth="0" scaleBasedVisibility="0" opacity="1" maxScaleDenominator="1e+8"  sizeScale="3x:0,0,0,0,0,0" minimumSize="0" scaleDependency="Area">
