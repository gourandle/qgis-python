...
<qgis version="3.0.2-Girona" simplifyMaxScale="1" maxScale="0" labelsEnabled="1" simplifyAlgorithm="0" minScale="1e+8" simplifyDrawingTol="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyDrawingHints="0">
  ...
  <labeling type="simple">
    <settings>
      <text-style fontStrikeout="0" useSubstitutions="0" previewBkgrdColor="#ffffff" namedStyle="Regular" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" multilineHeight="1" fontWordSpacing="0" fontSize="8.25" fontLetterSpacing="0" fontWeight="50" fontItalic="0" fontCapitals="0" fontFamily="MS Shell Dlg 2" blendMode="0" fieldName="Rainfall last 30 days" fontSizeUnit="Point" textColor="255,255,255,255" isExpression="0">
        ...
        <background shapeBorderColor="128,128,128,255" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeSizeUnit="MM" shapeOffsetY="0" shapeDraw="0" shapeSizeY="0" shapeBorderWidth="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeBorderWidthUnit="MM" shapeJoinStyle="64" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeRadiiY="0" shapeBlendMode="0" shapeOffsetX="0" shapeSVGFile="" shapeSizeX="0" shapeSizeType="0" shapeFillColor="255,255,255,255" shapeOffsetUnit="MM" shapeType="0" shapeRadiiUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1"/>
      ...
      <text-format decimals="3" plussign="0" wrapChar="" reverseDirectionSymbol="0" placeDirectionSymbol="0" multilineAlign="3" leftDirectionSymbol="&lt;" formatNumbers="0" addDirectionSymbol="0" rightDirectionSymbol=">"/>
      <placement fitInPolygonOnly="0" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" dist="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" yOffset="0" centroidWhole="0" distUnits="MM" offsetType="0" centroidInside="0" quadOffset="4" placement="6" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5" maxCurvedCharAngleOut="-25" repeatDistance="0" rotationAngle="0" xOffset="0" offsetUnits="MapUnit" placementFlags="10" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering obstacleType="0" obstacleFactor="1" scaleMin="1" scaleMax="10000000" fontLimitPixelSize="0" zIndex="0" drawLabels="1" fontMaxPixelSize="10000" upsidedownLabels="0" labelPerPart="0" limitNumLabels="0" scaleVisibility="0" obstacle="1" maxNumLabels="2000" mergeLines="0" displayAll="0" fontMinPixelSize="3" minFeatureSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory minScaleDenominator="-2.14748e+9" lineSizeType="MM" lineSizeScale="3x:0,0,0,0,0,0" backgroundColor="#ffffff" diagramOrientation="Up" enabled="0" barWidth="5" penAlpha="255" width="15" penColor="#000000" height="15" maxScaleDenominator="1e+8" sizeType="MM" rotationOffset="270" backgroundAlpha="255" penWidth="0" scaleBasedVisibility="0" opacity="1" labelPlacementMethod="XHeight" sizeScale="3x:0,0,0,0,0,0" minimumSize="0" scaleDependency="Area">
  ...
  <fieldConfiguration>
    ...
    <field name="Rainfall last 30 days">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="0" type="QString"/>
